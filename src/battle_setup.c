...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_EZEKIEL] = REMATCH(TRAINER_EZEKIEL_1, TRAINER_EZEKIEL_2, TRAINER_EZEKIEL_3, TRAINER_EZEKIEL_4, TRAINER_EZEKIEL_5, ROUTE117),
    ...
    [REMATCH_WALLY_VR] = REMATCH(TRAINER_WALLY_VR_2, TRAINER_WALLY_VR_2, TRAINER_WALLY_VR_2, TRAINER_WALLY_VR_2, TRAINER_WALLY_VR_2, VICTORY_ROAD_1F),
    ...
    [REMATCH_SIDNEY] = REMATCH(TRAINER_SIDNEY1, TRAINER_SIDNEY1, TRAINER_SIDNEY1, TRAINER_SIDNEY1, TRAINER_SIDNEY1, EVER_GRANDE_CITY),
    [REMATCH_PHOEBE] = REMATCH(TRAINER_PHOEBE1, TRAINER_PHOEBE1, TRAINER_PHOEBE1, TRAINER_PHOEBE1, TRAINER_PHOEBE1, EVER_GRANDE_CITY),
    [REMATCH_GLACIA] = REMATCH(TRAINER_GLACIA1, TRAINER_GLACIA1, TRAINER_GLACIA1, TRAINER_GLACIA1, TRAINER_GLACIA1, EVER_GRANDE_CITY),
    [REMATCH_DRAKE] = REMATCH(TRAINER_CYNTHIA, TRAINER_CYNTHIA, TRAINER_CYNTHIA, TRAINER_CYNTHIA, TRAINER_CYNTHIA, EVER_GRANDE_CITY),
