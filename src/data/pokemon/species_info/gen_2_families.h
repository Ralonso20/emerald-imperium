...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_TYPHLOSION] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = {ABILITY_FLASH_FIRE,  ABILITY_BLAZING_MOMENTUM,  ABILITY_BLAZING_SOUL },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_TYPHLOSION_HISUI] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = {ABILITY_BLAZE,  ABILITY_NONE,  ABILITY_GRIM_NEIGH },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Typhlosion"),
        .cryId = CRY_TYPHLOSION,
        .natDexNum = NATIONAL_DEX_TYPHLOSION,
    ...
    [SPECIES_TOTODILE] =
    {
        ...
        .abilities = {ABILITY_SHEER_FORCE,  ABILITY_NONE,  ABILITY_STRONG_JAW },
    ...
    [SPECIES_SENTRET] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = {ABILITY_RUN_AWAY,  ABILITY_FRISK,  ABILITY_NONE },
    ...
    [SPECIES_FURRET] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = {ABILITY_ADAPTABILITY,  ABILITY_FRISK,  ABILITY_NONE },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_HOOTHOOT] =
    {
        ...
        .abilities = {ABILITY_TINTED_LENS,  ABILITY_FRISK,  ABILITY_INSOMNIA },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_LEDIAN] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = {ABILITY_SWARM,  ABILITY_IRON_FIST,  ABILITY_NONE },
        .bodyColor = BODY_COLOR_RED,
...
#define TOGEPI_FAMILY_TYPE (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_NORMAL)
    ...
    [SPECIES_AMPHAROS_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
        .abilities = {ABILITY_THICK_FAT,  ABILITY_THICK_FAT,  ABILITY_MOLD_BREAKER },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Ampharos"),
    ...
    [SPECIES_JUMPLUFF] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY, EGG_GROUP_GRASS),
        .abilities = {ABILITY_CHLOROPHYLL,  ABILITY_LEAF_GUARD,  ABILITY_AERILATE },
        .bodyColor = BODY_COLOR_BLUE,
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset, rzMode)   \
    ...
    [SPECIES_GIRAFARIG] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = {ABILITY_SAP_SIPPER,  ABILITY_EARLY_BIRD,  ABILITY_INNER_FOCUS },
        .bodyColor = BODY_COLOR_YELLOW,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 45, SPECIES_FARIGIRAF}),
    },
    ...
    [SPECIES_FARIGIRAF] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = {ABILITY_SAP_SIPPER,  ABILITY_ARMOR_TAIL,  ABILITY_PARENTAL_BOND },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_DUNSPARCE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = {ABILITY_SERENE_GRACE,  ABILITY_RUN_AWAY,  ABILITY_NONE },
        .bodyColor = BODY_COLOR_YELLOW,
        ...
        .evolutions = EVOLUTION({EVO_MOVE_TWO_SEGMENT, MOVE_HYPER_DRILL, SPECIES_DUDUNSPARCE_TWO_SEGMENT},
                                {EVO_LEVEL, 45, SPECIES_DUDUNSPARCE_THREE_SEGMENT}),
    },
    ...
    [SPECIES_GRANBULL] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_FAIRY),
        .abilities = {ABILITY_INTIMIDATE,  ABILITY_STRONG_JAW,  ABILITY_BULL_RUSH },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_QWILFISH] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
        .abilities = {ABILITY_TOXIC_DEBRIS,  ABILITY_SWIFT_SWIM,  ABILITY_INTIMIDATE },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_SNEASEL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = {ABILITY_INNER_FOCUS,  ABILITY_FRISK,  ABILITY_INFILTRATOR },
        .bodyColor = BODY_COLOR_BLACK,
        .noFlip = TRUE,
    ...
    [SPECIES_WEAVILE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = {ABILITY_PRESSURE,  ABILITY_NONE,  ABILITY_TECHNICIAN },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_SNEASEL_HISUI] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = {ABILITY_INNER_FOCUS,  ABILITY_FRISK,  ABILITY_POISON_TOUCH },
        .bodyColor = BODY_COLOR_GRAY,
        .noFlip = TRUE,
        .speciesName = _("Sneasel"),
        .cryId = CRY_SNEASEL,
    ...
    [SPECIES_TEDDIURSA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = {ABILITY_PICKUP,  ABILITY_QUICK_FEET,  ABILITY_UNNERVE },
        .bodyColor = BODY_COLOR_BROWN,
        .noFlip = TRUE,
    ...
    [SPECIES_URSARING] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL_DAY, 48, SPECIES_URSALUNA},
                                {EVO_LEVEL_NIGHT, 48, SPECIES_URSALUNA_BLOODMOON}),
    },
    ...
    [SPECIES_MAGCARGO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = {ABILITY_SIMPLE,  ABILITY_FLAME_BODY,  ABILITY_BLAZING_SURGE },
        .bodyColor = BODY_COLOR_RED,
        .noFlip = TRUE,
    ...
    [SPECIES_CORSOLA] =
    {
        ...
        .abilities = {ABILITY_HUSTLE,  ABILITY_REGENERATOR,  ABILITY_NONE },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_REMORAID] =
    {
        ...
        .abilities = {ABILITY_HUSTLE,  ABILITY_SNIPER,  ABILITY_SKILL_LINK },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_OCTILLERY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_WATER_2),
        .abilities = {ABILITY_MEGA_LAUNCHER,  ABILITY_SNIPER,  ABILITY_SKILL_LINK },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_DELIBIRD] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_FIELD),
        .abilities = {ABILITY_VITAL_SPIRIT,  ABILITY_HUSTLE,  ABILITY_REFRIGERATE },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_SKARMORY] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = {ABILITY_FRISK,  ABILITY_STURDY,  ABILITY_WEAK_ARMOR },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_HOUNDOOM_MEGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = {ABILITY_DARK_AURA,  ABILITY_DARK_AURA,  ABILITY_SOLAR_POWER },
        .bodyColor = BODY_COLOR_BLACK,
        .speciesName = _("Houndoom"),
